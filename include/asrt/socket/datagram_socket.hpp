#ifndef AE94EE9E_A6D1_46E8_A1E3_CAC52A02CB82
#define AE94EE9E_A6D1_46E8_A1E3_CAC52A02CB82
...
public:
    ...
    explicit BasicDgramSocket(Reactor& reactor) : Base{reactor} {}
    ...
    return CheckDefaultPeerExists()
        .and_then([this](){ /* if default peer exists */
            ...
            return OsAbstraction::Connect(
                ...
                Types::MakeUnspecUnixSockAddress());
        })
        .map([this](){
            this->has_default_peer_ = false;
        });
...
#endif /* AE94EE9E_A6D1_46E8_A1E3_CAC52A02CB82 */
